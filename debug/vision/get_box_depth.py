...
from src.inference import boundary_detection, depth_estimation, pallet_detector, box_detector, ocr_parser
...
ocr_parser = ocr_parser.OCRParser()
...
def initialize(image_path):
    ...
    annotations = ocr_parser.get_annotations(image_path)
...
def process_single_image(image_path):
    ...
    left_pallet, right_pallet = pallet_detector.filter_and_split_pallets(image_path, boundaries, image_shape[1])
